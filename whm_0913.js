...
const server = http.createServer(function(request, response) { 
    ...
    // Make cPanel Account
    makeGetRequest(request, response, whm_host, 2086, create_whm_path, whm_authorization, true);
    ...
    makeGetRequest(request, function(){
        ...
        makeGetRequest(request, function(data) {
            ...
            makeGetRequest(request, response, whm_host, 2082, give_db_access_path, cpanel_authorization, true);
        }, whm_host, 2082, create_dbuser_path, cpanel_authorization, false);

    }, whm_host, 2082, create_database_path, cpanel_authorization, false);

    // List users
    //makeGetRequest(request, response, whm_host, 2082, user_list_path, true);
